"""
Django settings for anothersquareapp_47121 project.
...
ROOT_URLCONF = 'anothersquareapp_47121.urls'
...
WSGI_APPLICATION = 'anothersquareapp_47121.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "anothersquareapp_47121 API",
    "DESCRIPTION": "API documentation for anothersquareapp_47121 App",
    "VERSION": "v1",
}
